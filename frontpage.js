  ...
  return (
    <View style={{'backgroundColor':'black'}}>
      ...
      <div id='mainview' style={{display:'flex',flexWrap:'wrap',flexDirection:'row',padding:'40px','backgroundColor':'black'}}>
        ...
        <div style={{'display':'flex','padding':'0px','marginLeft':'-175px'}}>
            ...
            <button style={{backgroundColor:"#3275A6",marginLeft:130,height:50,width:100,border:'none',borderRadius:10}} onClick={()=>{
               ...
               <button style={{backgroundColor:"#3275A6",marginLeft:120,marginRight:'3px',height:50,width:100,border:'none',borderRadius:10}} onClick={()=>{
                props.navigation.navigate('Login',{'obj':renderer,'scene':scene})
            }}>Logn in</button>

                <button style={{backgroundColor:"#3275A6",marginLeft:120,height:50,width:100,border:'none',borderRadius:10}} onClick={()=>{
                  props.navigation.navigate('Info')
                }}>About <br></br> us</button>
            </div>
        
         
            </div>
            <Image style={{'width':'100px','height':'100px','marginLeft':'220px'}}
                source={require('./adfdenterprisesdark.jpg')}
                />
    </View>
  );
